...
# The if statement you make below will print the meaning of the movie rating specified at the
# beginning of the code. You should only need to replace the lines in CAPITALS with your own code.
